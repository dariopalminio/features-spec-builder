...
- **`definition-of-done-story.md`** — criterios de despliegue actualizados con validación npm (`npm pack --dry-run`, instalación limpia) y criterios de skills (uso de `skill-creator`, inclusión en `files` de `package.json`)
