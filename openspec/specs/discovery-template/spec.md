...
El sistema SHALL proveer `.claude/skills/project-discovery/templates/discovery-template.md` como template operacional de la fase Discovery, colocado junto al skill que lo usa.

#### Scenario: Template en ruta relativa al skill
- **WHEN** el skill `project-discovery` necesita el template
- **THEN** lo encuentra en `.claude/skills/project-discovery/templates/discovery-template.md` sin depender de rutas fuera del directorio del skill
...
- **THEN** el contenido de `.claude/skills/project-discovery/templates/discovery-template.md` permanece idéntico al estado previo a la ejecución
...
- **WHEN** el usuario ejecuta `/project-discovery` y completa el flujo
