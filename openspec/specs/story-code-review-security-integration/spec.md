# story-code-review-security-integration Specification

## Purpose
Defines the requirements for integrating the `security-audit` skill as a fourth parallel participant in `story-code-review`, scoped to the files modified by the story under review.
