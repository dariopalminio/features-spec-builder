...
- [x] 1.2 Verificar que existe `docs/specs/templates/story-gherkin-template.md` y revisar su estructura actual
...
- [x] 2.4 Documentar en SKILL.md el Paso 2: generación de cada historia siguiendo `story-gherkin-template.md`, inferiendo Como/Quiero/Para y escenarios Gherkin desde el nombre/descripción de la feature
- [x] 2.5 Documentar en SKILL.md el Paso 3: nombrado de archivos con el patrón `story-[ID]-[nombre-kebab].md` y guardado en `docs/specs/stories/`
...
- [x] 4.2 Verificar que los archivos generados siguen la estructura de `story-gherkin-template.md` con frontmatter, Como/Quiero/Para y al menos dos escenarios Gherkin
...
- [x] 5.1 Marcar FEAT-029 como completado (`[x]`) en `docs/specs/releases/release-06-release-and-story-generator.md`
