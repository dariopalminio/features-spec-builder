...
- [x] 2.2 Crear el template `docs/specs/templates/definition-of-done-template.md` con frontmatter y secciones: criterios de aceptación generales, criterios de código, criterios de tests, criterios de documentación, criterios de despliegue
...
- [x] 3.4 Redactar la Fase 3: leer template `definition-of-done-template.md` y generar `$SPECS_BASE/policies/definition-of-done.md` (modo crear vs. modo editar con confirmación)
...
- [x] 4.2 Crear `examples/example-output-dod.md` con un ejemplo realista de `definition-of-done.md` generado
