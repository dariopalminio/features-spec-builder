...
- `planning-agent`: Specialized agent that transforms specification documents into a prioritized feature backlog and release proposal, outputting `docs/specs/project/project-plan.md`
...
- Input: `docs/specs/project/clarifications.md` (and all prior phase docs)
