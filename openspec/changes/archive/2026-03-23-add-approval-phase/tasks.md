...
- [x] 2.2 Add Paso 1: Leer los cuatro documentos de entrada (`initial-prompt.md`, `project-intent.md`, `discovery.md`, `requirement-spec.md`) desde `$SPECS_BASE/specs/projects/`
- [x] 2.3 Add Paso 2: Validar Estado de `requirement-spec.md` — si `IN‑PROGRESS`, preguntar confirmación; si confirma, cambiar a `DONE` y continuar; si rechaza, detener
...
- [x] 3.2 Add Paso 1: Verificar que `$SPECS_BASE/specs/projects/project.md` existe — si no, informar al usuario y detener
...
- [x] 3.5 Add Paso 4: Confirmar que `$SPECS_BASE/specs/projects/clarifications.md` existe después de la ejecución del agente — si existe, mostrar mensaje de éxito y mencionar `/ps-plan`; si no, sugerir re-ejecutar `/ps-approval`
