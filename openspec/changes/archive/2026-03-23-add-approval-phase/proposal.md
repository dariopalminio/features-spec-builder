...
- **New**: `approval-agent.md` — specialized agent that reads all prior phase documents, analyzes them from three perspectives (PM, Architect, UX), interviews the user to resolve ambiguities, and produces `docs/specs/project/clarifications.md`
...
- Output path: `docs/specs/project/clarifications.md`
