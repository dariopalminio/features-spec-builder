...
- [x] 2.2 Documentar en SKILL.md la Fase 0: escanear `docs/specs/releases/` y listar todos los archivos `.md` en orden alfabético
...
- [x] 4.1 Documentar en SKILL.md la Fase 2: preparar directorio de destino `docs/specs/stories/` (crearlo si no existe)
...
- [x] 6.1 Ejecutar el skill sin argumentos y verificar que escanea todos los archivos de `docs/specs/releases/` y genera stories para cada uno
...
- [x] 6.4 Verificar que el skill muestra error descriptivo cuando `docs/specs/releases/` está vacío o no existe

## 7. Integración con el release activo

- [x] 7.1 Marcar FEAT-035 como completado (`[x]`) en `docs/specs/releases/release-06-release-and-story-generator.md`
