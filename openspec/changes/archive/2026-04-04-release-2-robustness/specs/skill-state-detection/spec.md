...
Al inicio de su ejecución, cada skill del pipeline SHALL leer el campo `**Estado**:` del documento de output de su fase en `docs/specs/project/` antes de delegar al agente.
