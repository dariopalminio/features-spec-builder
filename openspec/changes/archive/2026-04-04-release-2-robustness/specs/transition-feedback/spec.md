...
- **WHEN** el agente delegado completa su ejecución y el documento de output existe
- **THEN** el skill MUST mostrar al usuario: (1) confirmación de éxito, (2) path del documento generado, (3) el siguiente comando del workflow
...
- **WHEN** el skill `ps-planning` confirma éxito
- **THEN** el skill MUST indicar al usuario que el workflow está completo y el documento está listo para ser revisado
