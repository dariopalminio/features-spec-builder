...
Cuando el skill detecta `Estado: IN‑PROGRESS`, el agente delegado SHALL recibir instrucción de leer el documento existente, identificar las secciones incompletas y continuar solo con ellas, preservando el contenido ya capturado.
