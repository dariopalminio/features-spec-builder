...
- **WHEN** no existe ningún documento en `docs/specs/projects/` con `Estado: Doing`
...
El skill SHALL leer el campo `**Estado**:` de `docs/specs/projects/project-intent.md` si existe, aplicando la lógica de `skill-state-detection`.
...
El skill `/ps-begin-intention` SHALL producir `docs/specs/projects/project-intent.md` como único documento de salida.
