...
- **WHEN** no existe ningún documento en `docs/specs/project/` con `Estado: Doing`
...
El skill SHALL leer el campo `**Estado**:` de `docs/specs/project/project-intent.md` si existe, aplicando la lógica de `skill-state-detection`.
...
El skill `/ps-begin-intention` SHALL producir `docs/specs/project/project-intent.md` como único documento de salida.
