...
- [x] 1.5 `release-generate-stories/SKILL.md` — 1 referencia a `story-template.md` (línea 7 descripción)
- [x] 1.6 `release-generate-all-stories/SKILL.md` — 1 referencia a `story-template.md` (línea 7 descripción)
...
- [x] 1.9 `story-creation/SKILL.md` — 3 referencias a `story-template.md` (líneas 8 descripción, 19, 250)
- [x] 1.10 `story-split/SKILL.md` — 3 referencias a `story-template.md` (líneas 8 descripción, 193, 320)
- [x] 1.11 `story-evaluation/SKILL.md` — 2 referencias: `story-template.md` (línea 26) y `evaluation-output-template.md` (línea 228)
