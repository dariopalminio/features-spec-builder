...
- Update documentation files: `README.md`, `CLAUDE.md`, `$SPECS_BASE/specs/project-spec-factory/project.md`
...
- `$SPECS_BASE/specs/project-spec-factory/project.md` — agent list
