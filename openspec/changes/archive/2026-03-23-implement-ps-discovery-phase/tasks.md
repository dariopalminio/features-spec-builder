...
- [x] 2.2 Implementar Paso 1: el agente lee `docs/specs/project-intent.md` y el template al inicio
...
- [x] 2.6 Implementar Paso 5: escritura de `docs/specs/discovery.md` con metadatos (`**Versión**`, `**Estado**: Doing`, `**Fecha**`, `**Generado por**: discovery-agent`), sin comentarios HTML del template
...
- [x] 3.3 Implementar verificación de precondición: lee `docs/specs/project-intent.md`; si no existe, informa al usuario que debe ejecutar `/ps-draft` primero y detiene la ejecución
...
- [x] 3.6 Implementar confirmación del output: verifica que `docs/specs/discovery.md` existe tras la ejecución del agente; confirma éxito o sugiere re-ejecutar en caso de fallo

## 4. Validación end-to-end

- [x] 4.1 [Validación humana] Ejecutar `/ps-discovery` con un `docs/specs/project-intent.md` de prueba y verificar que el agente conduce la entrevista correctamente
- [x] 4.2 [Validación humana] Verificar que `docs/specs/discovery.md` es generado con las secciones del template y los metadatos correctos
