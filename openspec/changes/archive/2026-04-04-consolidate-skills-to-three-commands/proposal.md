...
- Crear skill `/ps-project-spec` — fusiona Discovery + Specifying: conduce discovery de usuarios y especificación de requisitos, genera `docs/specs/project/project.md`
