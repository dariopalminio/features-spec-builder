...
El skill `/ps-begin-intention` SHALL producir `$SPECS_BASE/specs/projects/project-intent.md` como único documento de salida, en una sola sesión interactiva que combina la captura de intención inicial y su refinamiento.
