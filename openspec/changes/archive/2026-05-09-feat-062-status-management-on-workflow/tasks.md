...
- [x] 1.4 Actualizar la sección de transiciones de estado en `.claude/skills/story-refine/SKILL.md` para reemplazar los valores `IN-PROGRESS`/`DONE` por `SPECIFYING/IN‑PROGRESS` y `SPECIFIED/DONE`
...
- [x] 3.4 Reflejar el estado resultante (`PLANNED/DONE` o `PLANNING/IN‑PROGRESS`) en la sección de confirmación del Paso 10
...
- [x] 6.3 Actualizar el `assets/README.md` de `story-refine` (o el SKILL.md) para reflejar las transiciones `SPECIFYING/IN‑PROGRESS` y `SPECIFIED/DONE`
