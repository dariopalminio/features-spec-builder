...
- [x] 2.3 Incluir en el prompt del agente las instrucciones para escribir `docs/specs/initial-prompt.md` con metadatos (fecha de generación, agente ejecutor)

## 3. Skill ps-funnel

- [x] 3.1 Crear directorio `.claude/skills/ps-funnel/`
- [x] 3.2 Crear `.claude/skills/ps-funnel/SKILL.md` con la lógica de orquestación: verificar existencia del template, invocar al agente `pm-agent`, confirmar que `docs/specs/initial-prompt.md` fue generado
...
- [x] 4.2 [Validación humana] Revisar el `docs/specs/initial-prompt.md` generado: comprobar que todas las secciones están completas, que el contenido inferido está marcado, y que los metadatos son correctos
