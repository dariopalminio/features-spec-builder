...
- Después de cada fase, el orquestador verifica el documento de output, presenta un resumen al usuario y solicita confirmación para marcarlo como `Ready` antes de continuar
