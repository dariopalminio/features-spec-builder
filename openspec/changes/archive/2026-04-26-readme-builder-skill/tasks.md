...
- [x] 1.3 Copy `$SPECS_BASE/specs/templates/readme-template.md` → `.claude/skills/readme-builder/templates/readme-template.md`
...
- [x] 3.1 Define Step 1 — check for formal spec artifacts: `$SPECS_BASE/specs/projects/project-intent.md`, `requirement-spec.md`, `project-plan.md`
