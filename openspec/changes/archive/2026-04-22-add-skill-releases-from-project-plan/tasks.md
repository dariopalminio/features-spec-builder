...
- [x] 1.1 Revisar `$SPECS_BASE/specs/templates/release-spec-template.md` para mapear todas las secciones obligatorias y opcionales que el skill debe poblar
...
- [x] 1.3 Revisar `$SPECS_BASE/specs/projects/project-plan.md` para confirmar la estructura exacta de los bloques `### Release NN — Nombre` que el skill debe parsear
...
- [x] 2.3 Implementar **Fase 0 — Verificar input**: verificar que `$SPECS_BASE/specs/projects/project-plan.md` existe; si no, mostrar "No se encontró docs/specs/projects/project-plan.md" y terminar
...
- [x] 2.5 Implementar **Fase 2 — Preparar directorio de destino**: verificar si `$SPECS_BASE/specs/releases/` existe; si no, crearlo
