...
- [x] 1.2 Crear `.claude/skills/ps-specifying/templates/requirement-spec-template.md` con estructura de secciones (Descripción General, Contexto, Usuarios, Requisitos Funcionales, Requisitos No Funcionales, Referencias, Definiciones) y comentarios `<!-- -->` guía en cada sección
...
- [x] 2.2 Implementar Paso 1: leer `docs/specs/project/discovery.md` y `.claude/skills/ps-specifying/templates/requirement-spec-template.md`
...
- [x] 2.7 Implementar Paso 6: escribir `docs/specs/project/requirement-spec.md` con el template como estructura, metadatos (Versión, Estado, Fecha, Generado por), sin comentarios HTML, y proponer revisión al usuario mencionando `/ps-approve`
...
- [x] 3.3 Implementar Paso 2: verificar que `.claude/skills/ps-specifying/templates/requirement-spec-template.md` existe; si no, informar y detener
- [x] 3.4 Implementar Paso 3: delegar al `specifying-agent` con instrucciones para leer `discovery.md` y el template, conducir entrevista y escribir `docs/specs/project/requirement-spec.md`
- [x] 3.5 Implementar Paso 4: verificar que `docs/specs/project/requirement-spec.md` existe y confirmar al usuario con mensaje de éxito y próximo paso (`/ps-approve`); si no existe, informar error y sugerir re-ejecutar
