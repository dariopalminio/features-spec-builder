...
- [x] 1.2 In Paso 0: check if `$SPECS_BASE/specs/projects/story-map.md` exists; if it does, read it and display a confirmation that it will be used as planning input
