...
Entonces "story.md" tiene status: SPECIFYING / substatus: IN-PROGRESS
  Y al aprobar FINVEST "story.md" tiene status: SPECIFIED / substatus: DONE
Cuando ejecuto "/story-plan FEAT-062"
Entonces "story.md" tiene status: PLANNING / substatus: IN-PROGRESS
  Y al finalizar "story-analyze" sin ERROREs "story.md" tiene status: PLANNED / substatus: DONE
...
Entonces "story.md" tiene status: IMPLEMENTING / substatus: IN-PROGRESS antes de la primera tarea
  Y al finalizar todas las tareas "story.md" tiene status: IMPLEMENTED / substatus: DONE
```
...
Cuando ejecuto "/story-implement FEAT-062"
Entonces veo el mensaje "❌ La historia FEAT-062 no está en estado PLANNED/DONE"
...
Entonces "story.md" permanece en status: PLANNING / substatus: IN-PROGRESS
  ...
  Pero no se actualiza el estado a PLANNED/DONE
```
...
Cuando "/story-implement" finaliza todas las tareas
  Y "story.md" se actualiza a status: IMPLEMENTED / substatus: DONE
...
Entonces se emite el mensaje "⚠️ No se pudo actualizar el release checklist"
  ...
  Pero la transición a IMPLEMENTED/DONE se aplica correctamente
```
...
Ejemplos:
  ...
  | /story-plan      | SPECIFIED/DONE         | PLANNING/IN-PROGRESS     |
  | /story-plan      | PLANNED/DONE           | PLANNING/IN-PROGRESS     |
  | /story-implement | PLANNED/DONE           | IMPLEMENTING/IN-PROGRESS |
```
...
* **Sin bloqueo por release.md:** la ausencia o desalineación del `release.md` padre emite un WARNING pero no impide la transición a `IMPLEMENTED/DONE`

## 📎 Notas / contexto adicional

La máquina de estados canónica es:
```
BACKLOG/TODO → SPECIFYING/IN-PROGRESS → SPECIFIED/DONE
             → PLANNING/IN-PROGRESS → PLANNED/DONE
             → IMPLEMENTING/IN-PROGRESS → IMPLEMENTED/DONE
```
