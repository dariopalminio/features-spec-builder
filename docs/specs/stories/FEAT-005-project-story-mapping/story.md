...
**Para** obtener `docs/specs/project/story-map.md` con la visualizaci�n del journey del usuario organizada en actividades, flujo m�nimo y releases incrementales
...
```gherkin
Dado que no existe ning�n documento previo en "docs/specs/project/"
Cuando el desarrollador ejecuta el skill "project-story-mapping"
