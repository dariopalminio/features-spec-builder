...
**Quiero** ejecutar un skill `project-policies-generation` que genere los documentos de políticas y constitución del proyecto (`constitution.md` y `definition-of-done.md`)  
...
Dado que estoy en la raíz de un proyecto SDDF
  Y los archivos $SPECS_BASE/policies/constitution.md y $SPECS_BASE/policies/definition-of-done.md NO existen
...
Entonces el skill crea $SPECS_BASE/policies/constitution.md a partir del template $SPECS_BASE/specs/templates/project-constitution-template.md
  Y crea $SPECS_BASE/policies/definition-of-done.md con la estructura definida en el template correspondiente
...
```gherkin
Dado que $SPECS_BASE/policies/constitution.md y $SPECS_BASE/policies/definition-of-done.md ya existen
Cuando ejecuto el skill `project-policies-generation`
