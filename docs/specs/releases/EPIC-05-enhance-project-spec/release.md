...
- [x] **Auto-especificación del framework**: Se ejecuta `/reverse-engineering` sobre el propio repositorio SDDF, generando `docs/specs/project/project.md` con 30 FRs, 13 NFRs, árbol de navegación ASCII y sección de gaps identificados.
