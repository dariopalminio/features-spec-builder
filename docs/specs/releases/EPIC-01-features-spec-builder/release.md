...
- [x] **FEAT-006 — story-creation**: Skill para crear historias de usuario en formato `Como/Quiero/Para` con criterios de aceptación Gherkin siguiendo el template `story-template.md`.
