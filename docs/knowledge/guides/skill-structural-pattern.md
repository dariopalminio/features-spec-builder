...
id: EPIC-NN
slug: nombre-kebab
status: BACKLOG | DISCOVERY | PLANNING | SPECIFYING | READY-FOR-IMPLEMENT | IMPLEMENTING | CODE-REVIEW | VERIFY | ACCEPTANCE | INTEGRATION | DELIVERED | DEFINITION | PLANNED | DEV-IN-PROGRESS | VERIFY-INTEGRATION | PUBLISH | RELEASED | CANCELED | BEGINNING | DISCOVERY | PLANNING | ACTIVE-DEVELOPMENT | MEASURING-VALUE | FINISHED
