...
status: <BACKLOG | BEGINNING | DISCOVERY | PLANNING | DEFINITION | REFINING | READY-FOR-IMPLEMENT | READY-FOR-DEVELOP | IN-PROGRESS | IN-DEVELOPMENT | DEVELOPING | TESTING | ACCEPTANCE | INTEGRATION | RELEASE | RELEASED | MEASURING-VALUE | COMPLETED | FINISHED | CANCELED | DELIVERED> # OBLIGATORIO
