...
1. Lee `docs/specs/projects/project.md` (el documento existente)
...
1. Crea el directorio `docs/specs/projects/` si no existe (usando `Write` con el path completo)
2. Escribe el documento completo en `docs/specs/projects/project.md`
